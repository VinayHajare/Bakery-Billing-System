...
public class BIll extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(242, 138, 182, 35));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 960, 590));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //add button action
        bill.setText(
        bill.getText()+name.getText()+"\t   "+quantity.getText()+"\t    "+price.getText()+"\n"
        );
